                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Raheel Ahmed</td>
                                        <td>Normal</td>
                                        <td> <input type="checkbox" class="form-check-input" id="checkbox1"></td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="row">
                                  <div class="col-md-10 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="choices form-select">
                                            <option value="square">ALI</option>
                                            <option value="square">Ahmed</option>
                                            <option value="square">Raheel</option>
                                        </select>
                                    </div>
                                 </div>
                                 <div class="col-md-2 col-12 mt-4">
                                     <div class="form-group">
                                     <button type="submit" class="btn btn-primary me-1 mb-1" disabled>Assign</button>
                                        </div>
                                    </div>
                                     </div>
                                </div>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Urgent</td>
                                        <td>
                                             <button type="submit" class="btn btn-primary me-1 mb-1">UnAssign</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500">2</td>
                                        ...
                                        <td>Raheel Ahmed</td>
                                        <td>Normal</td>
                                        <td> <button type="submit" class="btn btn-primary me-1 mb-1">UnAssign</button></td>
                                    </tr>
                                    <tr>
                                        <td class="text-bold-500">3</td>
                                        <td>The Xray Machine isn't showing images</td>
